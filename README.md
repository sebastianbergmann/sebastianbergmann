...
- [php/php-src](https://github.com/php/php-src) ([php-8.5.10](https://github.com/php/php-src/releases/tag/php-8.5.10), 4 days ago) - The PHP Interpreter
- [infection/infection](https://github.com/infection/infection) ([0.35.3](https://github.com/infection/infection/releases/tag/0.35.3), 5 days ago) - PHP Mutation Testing library
...
- [sebastianbergmann/type](https://github.com/sebastianbergmann/type) ([7.0.2](https://github.com/sebastianbergmann/type/releases/tag/7.0.2), 3 weeks ago) - Collection of value objects that represent the types of the PHP type system
