...
- [SymfonyCon/2025-talks](https://github.com/SymfonyCon/2025-talks) -  (5 days ago)
...
- [thePHPcc/caledonia](https://github.com/thePHPcc/caledonia) -  (4 weeks ago)
...
- [sebastianbergmann/phpunit](https://github.com/sebastianbergmann/phpunit) ([12.4.5](https://github.com/sebastianbergmann/phpunit/releases/tag/12.4.5), 2 days ago) - The PHP Unit Testing framework.
- [sebastianbergmann/php-code-coverage](https://github.com/sebastianbergmann/php-code-coverage) ([12.5.0](https://github.com/sebastianbergmann/php-code-coverage/releases/tag/12.5.0), 4 days ago) - Library that provides collection, processing, and rendering functionality for PHP code coverage information.
- [davidlattimore/wild](https://github.com/davidlattimore/wild) ([0.7.0](https://github.com/davidlattimore/wild/releases/tag/0.7.0), 4 weeks ago) - A very fast linker for Linux
...
- [sebastianbergmann/environment](https://github.com/sebastianbergmann/environment) ([8.0.3](https://github.com/sebastianbergmann/environment/releases/tag/8.0.3), 3 months ago) - Provides functionality that helps writing PHP code that has runtime-specific execution paths
