...
- [sebastianbergmann/php-file-iterator](https://github.com/sebastianbergmann/php-file-iterator) ([6.0.1](https://github.com/sebastianbergmann/php-file-iterator/releases/tag/6.0.1), 2 days ago) - FilterIterator implementation that filters files based on a list of suffixes, prefixes, and other exclusion criteria.
