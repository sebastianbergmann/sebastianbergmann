...
- [SymfonyCon/2025-talks](https://github.com/SymfonyCon/2025-talks) -  (4 days ago)
...
- [sebastianbergmann/phpunit](https://github.com/sebastianbergmann/phpunit) ([12.4.5](https://github.com/sebastianbergmann/phpunit/releases/tag/12.4.5), 1 day ago) - The PHP Unit Testing framework.
- [sebastianbergmann/php-code-coverage](https://github.com/sebastianbergmann/php-code-coverage) ([12.5.0](https://github.com/sebastianbergmann/php-code-coverage/releases/tag/12.5.0), 3 days ago) - Library that provides collection, processing, and rendering functionality for PHP code coverage information.
