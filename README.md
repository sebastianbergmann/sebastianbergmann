...
- [sebastianbergmann/recursion-context](https://github.com/sebastianbergmann/recursion-context) ([8.0.1](https://github.com/sebastianbergmann/recursion-context/releases/tag/8.0.1), 1 day ago) - Provides functionality to recursively process PHP variables
- [sebastianbergmann/cli-parser](https://github.com/sebastianbergmann/cli-parser) ([5.0.1](https://github.com/sebastianbergmann/cli-parser/releases/tag/5.0.1), 3 days ago) - Library for parsing CLI options
- [php/php-src](https://github.com/php/php-src) ([php-8.4.24](https://github.com/php/php-src/releases/tag/php-8.4.24), 5 days ago) - The PHP Interpreter
- [sebastianbergmann/php-code-coverage](https://github.com/sebastianbergmann/php-code-coverage) ([14.2.4](https://github.com/sebastianbergmann/php-code-coverage/releases/tag/14.2.4), 5 days ago) - Library that provides collection, processing, and rendering functionality for PHP code coverage information.
