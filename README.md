...
- [sebastianbergmann/comparator](https://github.com/sebastianbergmann/comparator) ([8.2.0](https://github.com/sebastianbergmann/comparator/releases/tag/8.2.0), today) - Provides the functionality to compare PHP values for equality.
