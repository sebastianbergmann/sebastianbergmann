...
- [staabm/side-effects-detector](https://github.com/staabm/side-effects-detector) - Analyzes php-code for side-effects. (1 day ago)
...
- [staabm/side-effects-detector](https://github.com/staabm/side-effects-detector) ([1.0.5](https://github.com/staabm/side-effects-detector/releases/tag/1.0.5), 1 day ago) - Analyzes php-code for side-effects.
...
- [sebastianbergmann/comparator](https://github.com/sebastianbergmann/comparator) ([6.1.1](https://github.com/sebastianbergmann/comparator/releases/tag/6.1.1), 3 days ago) - Provides the functionality to compare PHP values for equality.
