...
- [infection/infection](https://github.com/infection/infection) ([0.35.3](https://github.com/infection/infection/releases/tag/0.35.3), 1 day ago) - PHP Mutation Testing library
...
- [sebastianbergmann/diff](https://github.com/sebastianbergmann/diff) ([9.0.1](https://github.com/sebastianbergmann/diff/releases/tag/9.0.1), 3 days ago) - Diff implementation
- [sebastianbergmann/php-file-iterator](https://github.com/sebastianbergmann/php-file-iterator) ([7.0.2](https://github.com/sebastianbergmann/php-file-iterator/releases/tag/7.0.2), 3 days ago) - FilterIterator implementation that filters files based on a list of suffixes, prefixes, and other exclusion criteria.
...
- [sebastianbergmann/comparator](https://github.com/sebastianbergmann/comparator) ([8.4.0](https://github.com/sebastianbergmann/comparator/releases/tag/8.4.0), 3 weeks ago) - Provides the functionality to compare PHP values for equality.
