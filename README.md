...
- [sebastianbergmann/exporter](https://github.com/sebastianbergmann/exporter) ([8.0.1](https://github.com/sebastianbergmann/exporter/releases/tag/8.0.1), 2 days ago) - Provides the functionality to export PHP variables for visualization
- [sebastianbergmann/comparator](https://github.com/sebastianbergmann/comparator) ([8.1.1](https://github.com/sebastianbergmann/comparator/releases/tag/8.1.1), 4 days ago) - Provides the functionality to compare PHP values for equality.
...
- [signalkraft/mypyllant-component](https://github.com/signalkraft/mypyllant-component) ([v0.9.13](https://github.com/signalkraft/mypyllant-component/releases/tag/v0.9.13), 5 days ago) - Home Assistant component for the myVAILLANT API, controls Vaillant devices such as aroTHERM heatpumps and ecoTEC boilers
