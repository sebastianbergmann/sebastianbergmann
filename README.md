...
- [sebastianbergmann/environment](https://github.com/sebastianbergmann/environment) ([9.0.1](https://github.com/sebastianbergmann/environment/releases/tag/9.0.1), 2 days ago) - Provides functionality that helps writing PHP code that has runtime-specific execution paths
- [testcontainers/testcontainers-php](https://github.com/testcontainers/testcontainers-php) ([1.0.8](https://github.com/testcontainers/testcontainers-php/releases/tag/1.0.8), 5 days ago) - https://www.testcontainers.org implementation for PHP
