...
- [humbug/php-scoper](https://github.com/humbug/php-scoper) - 🔨 Prefixes all PHP namespaces in a file/directory to isolate the code bundled in PHARs. (today)
...
- [sebastianbergmann/comparator](https://github.com/sebastianbergmann/comparator) ([6.3.0](https://github.com/sebastianbergmann/comparator/releases/tag/6.3.0), 6 days ago) - Provides the functionality to compare PHP values for equality.
- [sebastianbergmann/phpunit](https://github.com/sebastianbergmann/phpunit) ([11.5.2](https://github.com/sebastianbergmann/phpunit/releases/tag/11.5.2), 3 weeks ago) - The PHP Unit Testing framework.
...
- [humbug/php-scoper](https://github.com/humbug/php-scoper) ([0.18.15](https://github.com/humbug/php-scoper/releases/tag/0.18.15), 4 months ago) - 🔨 Prefixes all PHP namespaces in a file/directory to isolate the code bundled in PHARs.
