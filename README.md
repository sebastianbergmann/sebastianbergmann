...
- [sebastianbergmann/comparator](https://github.com/sebastianbergmann/comparator) ([7.1.2](https://github.com/sebastianbergmann/comparator/releases/tag/7.1.2), today) - Provides the functionality to compare PHP values for equality.
- [sebastianbergmann/phpunit](https://github.com/sebastianbergmann/phpunit) ([12.3.2](https://github.com/sebastianbergmann/phpunit/releases/tag/12.3.2), today) - The PHP Unit Testing framework.
