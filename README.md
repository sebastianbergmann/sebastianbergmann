...
- [sebastianbergmann/comparator](https://github.com/sebastianbergmann/comparator) ([7.1.2](https://github.com/sebastianbergmann/comparator/releases/tag/7.1.2), 1 day ago) - Provides the functionality to compare PHP values for equality.
- [sebastianbergmann/phpunit](https://github.com/sebastianbergmann/phpunit) ([12.3.2](https://github.com/sebastianbergmann/phpunit/releases/tag/12.3.2), 1 day ago) - The PHP Unit Testing framework.
- [sebastianbergmann/recursion-context](https://github.com/sebastianbergmann/recursion-context) ([5.0.1](https://github.com/sebastianbergmann/recursion-context/releases/tag/5.0.1), 1 day ago) - Provides functionality to recursively process PHP variables
- [sebastianbergmann/type](https://github.com/sebastianbergmann/type) ([6.0.3](https://github.com/sebastianbergmann/type/releases/tag/6.0.3), 2 days ago) - Collection of value objects that represent the types of the PHP type system
