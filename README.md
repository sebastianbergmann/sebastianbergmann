...
- [thePHPcc/EventFlow](https://github.com/thePHPcc/EventFlow) -  (4 weeks ago)
...
- [php/php-src](https://github.com/php/php-src) ([php-8.4.24](https://github.com/php/php-src/releases/tag/php-8.4.24), 1 day ago) - The PHP Interpreter
- [sebastianbergmann/php-code-coverage](https://github.com/sebastianbergmann/php-code-coverage) ([14.2.4](https://github.com/sebastianbergmann/php-code-coverage/releases/tag/14.2.4), 1 day ago) - Library that provides collection, processing, and rendering functionality for PHP code coverage information.
...
- [sebastianbergmann/global-state](https://github.com/sebastianbergmann/global-state) ([9.0.1](https://github.com/sebastianbergmann/global-state/releases/tag/9.0.1), 2 months ago) - Snapshotting of global state, factored out of PHPUnit into a stand-alone component
