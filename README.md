...
- [sebastianbergmann/phpunit](https://github.com/sebastianbergmann/phpunit) ([13.2.5](https://github.com/sebastianbergmann/phpunit/releases/tag/13.2.5), today) - The PHP Unit Testing framework.
- [signalkraft/mypyllant-component](https://github.com/signalkraft/mypyllant-component) ([v0.9.19](https://github.com/signalkraft/mypyllant-component/releases/tag/v0.9.19), 3 days ago) - Home Assistant component for the myVAILLANT API, controls Vaillant devices such as aroTHERM heatpumps and ecoTEC boilers
