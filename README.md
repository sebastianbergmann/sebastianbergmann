...
- [infection/infection](https://github.com/infection/infection) - PHP Mutation Testing library (1 day ago)
...
- [infection/infection](https://github.com/infection/infection) ([0.35.2](https://github.com/infection/infection/releases/tag/0.35.2), 1 day ago) - PHP Mutation Testing library
- [sebastianbergmann/php-code-coverage](https://github.com/sebastianbergmann/php-code-coverage) ([14.3.1](https://github.com/sebastianbergmann/php-code-coverage/releases/tag/14.3.1), 4 days ago) - Library that provides collection, processing, and rendering functionality for PHP code coverage information.
...
- [sebastianbergmann/object-enumerator](https://github.com/sebastianbergmann/object-enumerator) ([8.1.0](https://github.com/sebastianbergmann/object-enumerator/releases/tag/8.1.0), 1 week ago) - Traverses array structures and object graphs to enumerate all referenced objects
