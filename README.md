...
- [sebastianbergmann/phpunit](https://github.com/sebastianbergmann/phpunit) ([11.3.4](https://github.com/sebastianbergmann/phpunit/releases/tag/11.3.4), 2 days ago) - The PHP Unit Testing framework.
...
- [sebastianbergmann/comparator](https://github.com/sebastianbergmann/comparator) ([6.0.2](https://github.com/sebastianbergmann/comparator/releases/tag/6.0.2), 1 month ago) - Provides the functionality to compare PHP values for equality.
