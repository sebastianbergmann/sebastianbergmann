...
- [sebastianbergmann/recursion-context](https://github.com/sebastianbergmann/recursion-context) ([8.0.1](https://github.com/sebastianbergmann/recursion-context/releases/tag/8.0.1), 3 days ago) - Provides functionality to recursively process PHP variables
- [sebastianbergmann/cli-parser](https://github.com/sebastianbergmann/cli-parser) ([5.0.1](https://github.com/sebastianbergmann/cli-parser/releases/tag/5.0.1), 5 days ago) - Library for parsing CLI options
...
- [sebastianbergmann/php-code-coverage](https://github.com/sebastianbergmann/php-code-coverage) ([14.2.4](https://github.com/sebastianbergmann/php-code-coverage/releases/tag/14.2.4), 1 week ago) - Library that provides collection, processing, and rendering functionality for PHP code coverage information.
- [sebastianbergmann/phpunit](https://github.com/sebastianbergmann/phpunit) ([13.2.6](https://github.com/sebastianbergmann/phpunit/releases/tag/13.2.6), 1 week ago) - The PHP Unit Testing framework.
...
- [sebastianbergmann/exporter](https://github.com/sebastianbergmann/exporter) ([8.1.1](https://github.com/sebastianbergmann/exporter/releases/tag/8.1.1), 3 weeks ago) - Provides the functionality to export PHP variables for visualization
- [sebastianbergmann/lines-of-code](https://github.com/sebastianbergmann/lines-of-code) ([5.0.2](https://github.com/sebastianbergmann/lines-of-code/releases/tag/5.0.2), 4 weeks ago) - Library for counting the lines of code in PHP source code
- [sebastianbergmann/comparator](https://github.com/sebastianbergmann/comparator) ([8.3.0](https://github.com/sebastianbergmann/comparator/releases/tag/8.3.0), 2 months ago) - Provides the functionality to compare PHP values for equality.
- [sebastianbergmann/diff](https://github.com/sebastianbergmann/diff) ([9.0.0](https://github.com/sebastianbergmann/diff/releases/tag/9.0.0), 2 months ago) - Diff implementation
