...
- [sebastianbergmann/comparator](https://github.com/sebastianbergmann/comparator) ([8.4.0](https://github.com/sebastianbergmann/comparator/releases/tag/8.4.0), 3 days ago) - Provides the functionality to compare PHP values for equality.
- [sebastianbergmann/exporter](https://github.com/sebastianbergmann/exporter) ([8.2.1](https://github.com/sebastianbergmann/exporter/releases/tag/8.2.1), 3 days ago) - Provides the functionality to export PHP variables for visualization
