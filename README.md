...
- [signalkraft/mypyllant-component](https://github.com/signalkraft/mypyllant-component) ([v0.9.18](https://github.com/signalkraft/mypyllant-component/releases/tag/v0.9.18), today) - Home Assistant component for the myVAILLANT API, controls Vaillant devices such as aroTHERM heatpumps and ecoTEC boilers
