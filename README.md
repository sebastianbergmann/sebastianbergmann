...
- [sebastianbergmann/exporter](https://github.com/sebastianbergmann/exporter) ([6.2.0](https://github.com/sebastianbergmann/exporter/releases/tag/6.2.0), today) - Provides the functionality to export PHP variables for visualization
