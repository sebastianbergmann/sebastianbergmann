...
- [sebastianbergmann/environment](https://github.com/sebastianbergmann/environment) ([9.1.0](https://github.com/sebastianbergmann/environment/releases/tag/9.1.0), 6 days ago) - Provides functionality that helps writing PHP code that has runtime-specific execution paths
