...
- [sebastianbergmann/comparator](https://github.com/sebastianbergmann/comparator) ([6.3.1](https://github.com/sebastianbergmann/comparator/releases/tag/6.3.1), today) - Provides the functionality to compare PHP values for equality.
