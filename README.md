...
- [vimeo/php-mysql-engine](https://github.com/vimeo/php-mysql-engine) ([0.5.6](https://github.com/vimeo/php-mysql-engine/releases/tag/0.5.6), 3 days ago) - A MySQL engine written in pure PHP
...
- [Do not mock what you do not own](https://thephp.cc/news/2021/04/do-not-mock-what-you-do-not-own) (5 days ago)
