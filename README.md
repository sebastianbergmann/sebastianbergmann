...
- [sebastianbergmann/git-state](https://github.com/sebastianbergmann/git-state) ([1.0.0](https://github.com/sebastianbergmann/git-state/releases/tag/1.0.0), 1 day ago) - Library for describing the state of a Git checkout.
- [sebastianbergmann/environment](https://github.com/sebastianbergmann/environment) ([9.0.1](https://github.com/sebastianbergmann/environment/releases/tag/9.0.1), 1 week ago) - Provides functionality that helps writing PHP code that has runtime-specific execution paths
